...
-- Adicionando seções para organizar a interface com espaçamento
local Settings = Main:Divider{
    Name = "Settings",
    Position = UDim2.new(0, 0, 0, 10) -- Espaçamento do topo da UI
}

local Controls = Main:Divider{
    Name = "Controls",
    Position = UDim2.new(0, 0, 0, Settings.Position.Y.Offset + Settings.Size.Y.Offset + 50) -- Espaçamento maior abaixo de Settings
}

local ESPSettings = Main:Divider{
    Name = "ESP Settings",
    Position = UDim2.new(0, 0, 0, Controls.Position.Y.Offset + Controls.Size.Y.Offset + 50) -- Espaçamento maior abaixo de Controls
}
